...
#ifndef PLAY_MUSIC_SWIFT_H
#define PLAY_MUSIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Play_Music",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Play_Music11AppDelegate")
...
SWIFT_CLASS("_TtC10Play_Music13SceneDelegate")
...
SWIFT_CLASS("_TtC10Play_Music14ViewController")
...
- (void)viewDidLoad;
- (IBAction)previousButton:(UIButton * _Nonnull)sender;
- (IBAction)nextButton:(UIButton * _Nonnull)sender;
- (IBAction)restartButton:(UIButton * _Nonnull)sender;
- (IBAction)playButton:(UIButton * _Nonnull)sender;
